public class Main {
	public static void main(String args[]) {
		...
		do {
			...
			pila.revolver();
			System.out.println("----------------");
			mano1.recibirCarta(pila.darCarta(1, 999)); // cuando se da una carta esta carta se quita del objeto que da
														// la
														// carta //999 significa que no importa el orden
			mano2.recibirCarta(pila.darCarta(2, 999)); // cuando se da manuna carta esta carta se quita del objeto que
														// da
														// la
														// carta
